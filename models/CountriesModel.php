...
class CountriesModel{
    ...
    public function getCountryESByUniversityId($idUniversitat){

        $consulta = $this->db->prepare("SELECT nomPaisES FROM pais INNER JOIN universitats on universitats.idPais=pais.idPais WHERE universitats.idUniversitat=?");
