            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Aquest portal es troba sota desenvolupament. Preguem que, si trobeu cap error, disculpeu les molèsties.

                        En cas que l'error persisteixi agrairíem que contactéssiu amb l'administrador.

                        Gràcies
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">D'acord</button>
                    </div>
                </div>
            </div>
        </div>
