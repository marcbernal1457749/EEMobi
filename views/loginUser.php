...
<head>
  ...
  <link rel='stylesheet prefetch' href='/EEmobi/resources/css/test/bootstrap.min.css'>
...
<body>
    ...
    <input type="hidden" name="submit-form" value="form-user-login">     
      <h2 class="form-signin-heading">Iniciar sessió</h2>
      <input type="text" class="form-control" name="username" placeholder="Niu" required="" autofocus="" />
