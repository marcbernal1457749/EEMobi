...
<table  id="tableUE" class="table table-striped table-bordered table-list" cellspacing="10" >
    ...
    <tbody id="myTable">
      ...
      <tr>
        ...
        <td><?php echo $university->nom.' '.$university->cognoms; ?></td>
        ...
        <td style="display:none;"><?php echo $university->niuProfessor; ?></td>
      </tr>
    <?php endforeach; ?>
            ...
            <div class="col-sm-12">
                <form method="post" id="formall">
                    ...
                    <label for="sel1">Professor responsable:</label>
                      <select name="teachers" class="form-control selectpicker" data-live-search="true" data-size="5" id="teacher">
