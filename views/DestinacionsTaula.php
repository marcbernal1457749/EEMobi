           ...
           foreach($assignaturesSeleccionades as $assignatura) : ?>
               <tr>
                   ...
                   <td align="center" valign="middle">
                       <a target="_blank" href="<?php echo $assignatura['urlUniversitat']; ?>"><img class="click" src="./resources/images/click.png"></a>
                   </td>
                   <td align="center" valign="middle">
                       <a target="_blank" href="<?php echo $assignatura['urlIntercanvis']; ?>"><img class="click" src="./resources/images/click.png"></a></td>
                   <td align="center" valign="middle">
                       <?php if($logged){?>
